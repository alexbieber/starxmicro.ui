...
export function resolveAppRoute(locationLike, catalog) {
  ...
  if (pathname === STATIC_ROUTE_PATHS.about) return staticRoute("about");
  if (pathname === STATIC_ROUTE_PATHS.mcp) {
    return { page: "about", canonicalPath: STATIC_ROUTE_PATHS.about, legacy: true };
  }
