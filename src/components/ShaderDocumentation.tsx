...
function OpenShaderDocumentation({ shader, activeVariantId, onInstall, onSearchTag, onSelect, onVariantSelect }: ShaderDocumentationProps) {
      ...
      <div className="pane-inner">
        <main className="doc" id="doc" ref={docRef}>
          <div className="doc-intro">
            <div className="doc-topline">
              ...
              <div className="doc-actions">
                ...
                <div className="doc-promos-compact" aria-label="StarX UI installation">
                  <RightRailPromos onInstall={onInstall} />
                </div>
              </div>
            </div>
            <p className="lede">
          ...
          <section className="demo inset-shadow" id="usage" aria-label="Usage">
            <div
              className={`preview shader-preview ${shader.id}${shader.category === "Landing Pages" || shader.category === "Hero" || shader.origin === "StarX UI original" ? " tall-page-preview" : ""}`}
