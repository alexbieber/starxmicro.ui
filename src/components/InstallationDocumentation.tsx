...
const REQUIREMENTS = [
  ...
  { name: "three", type: "peer", value: ">= 0.149" },
    ...
    <>
      <div className="pane-inner">
        <main className="doc" id="doc">
          ...
          <h1>Installation</h1>
          <p className="lede">Install StarX UI from the local package, add the shared styles, and render your first live component.</p>
          ...
          <div className="integrity card">
            ...
            <div>
              <strong>Open a ready renderer</strong>
              <p>Every component page includes a live preview, exact import name, runtime contract, and its first-party source record.</p>
            </div>
          </div>
        ...
        <aside className="rail">
          <RightRailPromos onInstall={() => copyText(INSTALL_COMMANDS.npm).then(() => notify("Copied"))} />
