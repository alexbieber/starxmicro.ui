...
export const SITE_TITLE = "Three.js components you can actually ship";
export const SITE_DESCRIPTION = "Live previews. Copy-ready source. Fully customizable.";
    ...
    <main className="browse-page" aria-labelledby="browse-title">
      <header className="browse-header">
        <div className="browse-heading-row">
          <div>
            {!activeCategory && !activeTag ? <p className="browse-eyebrow">StarX UI catalog</p> : null}
