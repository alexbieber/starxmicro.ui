const DEFAULT_BROWSE_CONTENT = Object.freeze({
  ...
  heading: "Three.js components you can actually ship",
  description: "Browse live Three.js components, full-page templates, WebGL backgrounds, and copy-ready source — then drop them into a React app.",
});
...
const CATEGORY_FAQS = Object.freeze({
  ...
  "Three.js": Object.freeze([
    ...
    Object.freeze({
      question: "Do StarX UI components require React?",
...
export function browseTagContent(tag, resultCount = 0) {
  ...
  return {
    ...
    description: `Explore ${countText}StarX UI components, templates, backgrounds, and interactive effects tagged ${label}, with previews and editable implementation source.`,
  };
}
